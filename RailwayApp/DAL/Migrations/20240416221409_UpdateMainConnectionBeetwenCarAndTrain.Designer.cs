...
namespace DAL.Migrations
{
    ...
    [Migration("20240416221409_UpdateMainConnectionBeetwenCarAndTrain")]
    partial class UpdateMainConnectionBeetwenCarAndTrain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Train", b =>
                {
                    b.HasOne("DAL.Entities.Carriage", "Carriage")
                        .WithOne("Train")
                        .HasForeignKey("DAL.Entities.Train", "CarriageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
